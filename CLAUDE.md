...
3. **Imbalances** — FVG, VI, GAP, Implied FVG, Inverse FVG, Liquidity Voids (12 unified loops). The `…(±) Mitigation` alertconditions read plain (non-`var`) per-bar touch flags — adding `var` back would latch them true forever
